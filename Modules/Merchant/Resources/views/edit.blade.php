...
@section ('title', __('merchant::labels.backend.merchant.management') . ' | ' . __('merchant::labels.backend.merchant.edit'))
                ...
                <div class="col">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10" style="display: flex;">
                            <div class="col-md-6">
                                {{ html()->text('latitude', $merchant->latitude)
                                    ->class('form-control')
                                    ->id('input-latitude')
                                    ->placeholder(__('merchant::labels.backend.merchant.table.latitude')) }}
                            </div>
                            <div class="col-md-6">
                                {{ html()->text('longitude', $merchant->longitude)
                                    ->class('form-control')
                                    ->id('input-longitude')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            {{ html()->select('status', $merchantStatus::AVAILABLES_CREATE, $merchant->status)
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            {{ html()->select('active', [1 => 'Active', 0 => 'Inactive'], $merchant->active)
                                ->class('form-control select2 merchant_active')
                                ->required() }}
                        </div>
                    </div>
                </div><!--col-->
